%% Cargar datos
Centro = load(['CasoII_Resultados/Centro/Centro50'],'Referencia').Referencia;
Kobe = load(['CasoII_Resultados/Kobe/Kobe50'],'Referencia').Referencia;
Maule = load(['CasoII_Resultados/Maule/Maule50'],'Referencia').Referencia;
...
% exportgraphics(gcf,'Figs/CasoII/Corte_casoII.jpg',"Resolution",1000)
...
lh = legend('Orientation','horizontal');
lh.Layout.Tile = 'South';
% exportgraphics(gcf,['Figs/CasoII/RespuestaMAX_casoII.jpg'],"Resolution",1000)
...
lh = legend('Orientation','horizontal');
lh.Layout.Tile = 'South';
% exportgraphics(gcf,['Figs/CasoII/RespuestaRMS_casoII.jpg'],"Resolution",1000)
...
Referencia = load(['CasoII_Resultados/Centro/Centro50'],'Referencia').Referencia;
...
ylabel('Fuerza [kN]');
xlim([10 30]);
% exportgraphics(gcf,['Figs/CasoII/Respuesta_casoII_FvsFA.jpg'],"Resolution",1000)
...
% exportgraphics(gcf,['Figs/CasoII/Respuesta_casoII_RscvsRcc.jpg'],"Resolution",1000)

%% Cargar datos Centro diferentes magnitudes
% Escala 10%
Referencia = load(['CasoII_Resultados/Centro/Centro10'],'Referencia').Referencia;
...
% Escala 30%
Referencia = load(['CasoII_Resultados/Centro/Centro30'],'Referencia').Referencia;
...
% Escala 60%
Referencia = load(['CasoII_Resultados/Centro/Centro60'],'Referencia').Referencia;
...
% Escala 10%
Referencia = load(['CasoII_Resultados/Kobe/Kobe10'],'Referencia').Referencia;
...
% Escala 30%
Referencia = load(['CasoII_Resultados/Kobe/Kobe30'],'Referencia').Referencia;
...
% Escala 60%
Referencia = load(['CasoII_Resultados/Kobe/Kobe60'],'Referencia').Referencia;
...
% Escala 10%
Referencia = load(['CasoII_Resultados/Maule/Maule10'],'Referencia').Referencia;
...
% Escala 30%
Referencia = load(['CasoII_Resultados/Maule/Maule30'],'Referencia').Referencia;
...
% Escala 60%
Referencia = load(['CasoII_Resultados/Maule/Maule60'],'Referencia').Referencia;
