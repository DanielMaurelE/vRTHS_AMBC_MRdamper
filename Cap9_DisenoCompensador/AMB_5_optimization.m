...
x=op_location';
save Resultados/OPTIMO op_location op_value

%% R2 Maps around the optimal gain
tic
load OPTIMO
x = op_location';    %Optimal gain coeficientes (x=log10(diag(adaptivegain))
puntos=12;   %Grid size puntosxpuntos
nticks=2;
upperbounds=ceil(x)+4;  %Upper and lower bounds for adaptive gains
lowerbounds=floor(x)-4;
...
%% Save results 
save('Resultados/MapsR2dR2maxJ2','resultadosR2_16','resultadosdR2_16','resultadosmaxJ2_16')
save('Resultados/MapsR2dR2maxJ2','resultadosR2_26','resultadosdR2_26','resultadosmaxJ2_26','-append')
save('Resultados/MapsR2dR2maxJ2','resultadosR2_36','resultadosdR2_36','resultadosmaxJ2_36','-append')
save('Resultados/MapsR2dR2maxJ2','resultadosR2_46','resultadosdR2_46','resultadosmaxJ2_46','-append')
save('Resultados/MapsR2dR2maxJ2','resultadosR2_56','resultadosdR2_56','resultadosmaxJ2_56','-append')
save('Resultados/MapsR2dR2maxJ2','resultadosR2_66','resultadosdR2_66','resultadosmaxJ2_66','-append')
save('Resultados/MapsR2dR2maxJ2','x','-append')
...
%%
gcf = figure('Position', [10 10 800 500]); 
tiledlayout(2,3);
nexttile 
contourf(X,Y,log10(resultadosR2_16),contornos,'Linecolor','none')
set(gca,'YScale','log')
...
colormap(parula(1000))
pbaspect([1 1 1])
cb = colorbar('Ticks',log10([1,2,5,10,20,50,100]),'TickLabels',{'R_2<1%','2%','5%','10%','20%','50%','R_2>100%'});
cb.Layout.Tile = 'east';
exportgraphics(gcf,'Figs/R2.jpg',"Resolution",1000)
